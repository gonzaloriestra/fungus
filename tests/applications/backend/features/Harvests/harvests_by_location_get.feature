Feature: Recover harvests associated to a location
  ...
  Scenario: Get all the harvests of a location
    ...
    When I send a GET request to "/locations/2787d79f-eda8-43b7-91a8-504884a7a616/harvests"
    Then the response status code should be 200
    And the response should contains an element with id "1431829c-0cb3-493f-b101-ea3e3202215a"
    And the response should contains an element with id "94996a63-27ae-412f-bfb2-94c27ebe0422"
